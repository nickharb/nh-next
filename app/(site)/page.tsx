  ...
  return (
    <div className='mt-5 md:mt-10 lg:mt-20'>
      ...
      <div className='mt-10 md:flex md:gap-5 lg:mt-20'>
        ...
        <a href='https://www.linkedin.com/in/nickharb/' target='_blank' rel='noreferrer' className='block py-1 underline'>LinkedIn</a>
        <a href='https://medium.com/@nickharb' target='_blank' rel='noreferrer' className='block py-1 underline'>Medium</a>
      </div>
    </div>
  )
}
